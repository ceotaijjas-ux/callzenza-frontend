...
for filepath in files_to_update:
    ...
    # Restore the internal tab buttons
    ...
    content = content.replace('{tab !== "history" && (', '{lowerTab === "DETAILS" && (')
    content = content.replace('{tab === "history" && (', '{lowerTab === "LIVE" && (')
