...
import { Paperclip, FileText, Download, Loader2, Send } from 'lucide-react'
...
export default function ChatThread({ lead, messages, onSend }) {
        ...
        {messages.map((m) => (
          <div
            ...
            className={
              ...
              (m.from === 'agent' || m.from_type === 'agent'
