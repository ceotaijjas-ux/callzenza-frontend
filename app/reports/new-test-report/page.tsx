...
export default function NewTestReportPage() {
  const formattedTitle = "New Test Report";
  const slug = "new-test-report";
  ...
  const exportCSV = () => {
    ...
    link.href = url;
    link.download = `new-test-report.csv`;
    link.click();
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-slate-500 text-xs md:text-sm">
              Custom report metrics, test campaign evaluation, and process analysis
            </p>
          </div>
