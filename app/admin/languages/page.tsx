    ...
    <AppShell>
      <div className="p-8 space-y-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-slate-500 font-medium">Manage and configure your languages settings here.</p>
        </div>
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
          <div className="flex flex-col items-center justify-center text-center space-y-4 py-12">
            ...
            <h3 className="text-xl font-bold text-slate-900">Languages Configuration</h3>
            <p className="text-slate-500 max-w-md">This is a placeholder page for the Languages module. You can customize this page later with specific tables, forms, and settings.</p>
          </div>
        </div>
      </div>
    </AppShell>
